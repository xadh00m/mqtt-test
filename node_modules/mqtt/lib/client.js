...
function sendPacket (client, packet, cb) {
  console.log(`${new Date().toJSON()}: Send ${packet.cmd.toUpperCase()} (${packet.messageId || "none"}) ${packet.cmd === "publish" ? packet.topic : ""}`)
...
MqttClient.prototype._setupStream = function () {
  ...
  parser.on('packet', function (packet) {
    console.log(`${new Date().toJSON()}: Received ${packet.cmd.toUpperCase()} (${packet.messageId || "none"}) ${packet.cmd === "publish" ? packet.topic : ""}`)
    packets.push(packet)
  })
